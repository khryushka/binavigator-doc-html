...
<div class="middle-block">
	<div class="wrapper">
		...
		<div class="right-column col-xs-8">
			...
			<!-- Caption -->
			<h1 class="caption">Список сотрудников</h1>
			<!-- /Caption -->
			...
			<div class="body">
				...
				<br/>
				Состав вводимой информации: фамилия, имя, отчество, должность (необходимо выбрать из списка ранее введённых должностей), подразделение (необходимо выбрать из списка ранее введённых подразделений). <br/>
